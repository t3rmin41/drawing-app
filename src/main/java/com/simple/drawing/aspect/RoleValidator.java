...
import com.simple.drawing.validation.RequestValidator;
...
public class RoleValidator implements RequestValidator {
  ...
  @Pointcut("execution(* com.simple.drawing.controller.rest.UserController.loginSuccessfull(..)) || "+
            "execution(* com.simple.drawing.controller.rest.UserController.logout(..)) || "+
            "execution(* com.simple.drawing.controller.rest.UserController.getUserRoleMap(..))" +
            "execution(* com.simple.drawing.controller.rest.UserController.getUserById(..))"
     )
